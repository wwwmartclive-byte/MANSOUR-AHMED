...
.mood{
  background:
    ...
    url("malcolm.jpg") center/cover no-repeat;
  text-align:center;
  color:#fff;
  padding:70px 20px;
}
...
<p>حفرة جهنم — MBC & Shahid Studio AlSadaf (In Production)</p>
<img class="project-image" src="malcolm.jpg" alt="Malcolm X Project Highlight">
</section>
